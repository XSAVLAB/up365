...
import { fetchLotteryBets } from '../../../api/firestoreService'; // Update the import path according to your project structure
    ...
    useEffect(() => {
        const unsubscribe = onAuthStateChanged(auth, async (currentUser) => {
            if (currentUser) {
                setUser(currentUser);
                try {
                    const fetchedBets = await fetchLotteryBets(currentUser.uid, 'Single Digit Lottery');
