...
export default function TopCricket() {
  ...
  useEffect(() => {
    const fetchCricketMatches = async () => {
      try {
        const matchesCollectionRef = collection(db, 'cricketMatches');
        ...
        console.log('Cricket Matches:', matchesData);
                              ...
                              <div className="top_matches__cmncard-left d-flex align-items-center justify-content-between pe-xl-10">
                                <div>
                                  <div className="d-flex align-items-center gap-2 mb-4">
                                    <Image
                                      className="rounded-5"
                                      src={match.teamOne} width={24} height={24}
                                      alt="Icon"
                                    />{" "}
                                  ...
                                  <div className="d-flex align-items-center gap-2">
                                    <Image
                                      className="rounded-5"
                                      src={match.teamTwo} width={24} height={24}
                                      alt="Icon"
                                    />{" "}
                                    <span className="fs-seven cpoint">
                                      {match.teamNameTwo}
