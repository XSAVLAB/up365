...
export default function UpCmingDarts() {
    return (
                                                    ...
                                                    <div className="top_matches__clubname">
                                                        <div
                                                            ...
                                                            <div className="d-flex align-items-center gap-1">
                                                                <Image src="/images/icon/darts.png" width={16} height={16} alt="Icon" /> <span
                                                            ...
                                                            <div
                                                                ...
                                                                <span className="fs-eight cpoint me-xl-6">Today, 16:10</span>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div>
                                                                <div className="d-flex align-items-center gap-2 mb-4">
                                                                    <Image className="rounded-5"
                                                                        src="/images/icon/darts-2.png" width={24} height={24}
                                                            ...
                                                            <table className="table mb-0 pb-0">
                                                                <thead>
                                                                    <tr className="text-start">
                                                                        <th scope="col"><span className="fs-eight ms-17">Winner</span>
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                <div className="d-flex align-items-center gap-2 mb-4">
                                                                    <Image className="rounded-5"
                                                                        src="/images/icon/darts-2.png" width={24} height={24}
                                                                        alt="Icon" /> <span className="fs-seven cpoint">AZS Uw
                                                                            Wilanow</span>
                                                                </div>
                                                                <div className="d-flex align-items-center gap-2">
                                                                    <Image className="rounded-5"
                                                                        src="/images/icon/darts-2.png" width={24} height={24}
                                                                        alt="Icon" /> <span className="fs-seven cpoint">Widzew
                                                                            Lodz</span>
                                                                </div>
                                                            </div>
                                                            <div
